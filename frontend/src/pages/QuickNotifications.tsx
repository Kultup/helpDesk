...
import { AlertTriangle, CheckCircle2, XCircle, MessageSquare, Send, Save, FileText, Info, AlertCircle, CheckCircle, X, Trash2 } from 'lucide-react';
...
const QuickNotifications: React.FC = () => {
  ...
  const [templateCategory, setTemplateCategory] = useState<'ticket' | 'user' | 'system' | 'security' | 'maintenance'>('system');
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            {t('quickNotifications.quickMessageTitle')}
          </p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-surface rounded-xl border border-border p-6 shadow-sm">
            ...
            <div className="flex gap-3">
              ...
              >
                <option value="">
                  {templatesLoading ? t('quickNotifications.loadingTemplates') : t('quickNotifications.selectTemplatePlaceholder')}
                </option>
                {templates.length === 0 && !templatesLoading ? (
                  <option value="" disabled>{t('quickNotifications.noTemplates')}</option>
                ) : (
                  templates.map((tpl) => (
            ...
            <div className="bg-surface rounded-xl border border-border p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3">
                <Button 
                  ...
                  disabled={savingTemplate || !(templateMessage ?? message).trim() || !templateName.trim()}
                >
                  {savingTemplate ? t('quickNotifications.savingTemplate') : t('quickNotifications.saveAsTemplate')}
                </Button>
                <Button
                  variant="outline"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface rounded-xl border border-border p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-foreground">{t('quickNotifications.previewTitle')}</h3>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              {t('quickNotifications.deleteConfirmMessage')}
            </p>
