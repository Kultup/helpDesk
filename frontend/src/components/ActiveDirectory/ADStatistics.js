    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <FaChartPie className="text-purple-600" size={24} />
          <h2 className="text-2xl font-bold text-gray-800">{t('activeDirectory.statistics.title')}</h2>
        </div>
        <button
          onClick={handleRefresh}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">{t('activeDirectory.statistics.totalUsers')}</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">{t('activeDirectory.statistics.totalComputers')}</p>
              <p className="text-2xl font-bold text-gray-900">{statistics.computers.total}</p>
            </div>
          </div>
          <div className="mt-4 flex justify-between text-sm">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            <div className="p-3 rounded-full bg-purple-100">
              <FaBuilding className="text-purple-600" size={24} />
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">{t('activeDirectory.statistics.departments')}</p>
              <p className="text-2xl font-bold text-gray-900">{Object.keys(statistics.departments).length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            <div className="p-3 rounded-full bg-orange-100">
              <FaChartPie className="text-orange-600" size={24} />
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">{t('activeDirectory.statistics.osTypes')}</p>
              <p className="text-2xl font-bold text-gray-900">{Object.keys(statistics.operatingSystems).length}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Графік користувачів */}
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('activeDirectory.statistics.userDistribution')}</h3>
          <div className="h-64">
        ...
        {/* Графік комп'ютерів */}
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('activeDirectory.statistics.computerDistribution')}</h3>
          <div className="h-64">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {osLabels.length > 0 && (
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('activeDirectory.statistics.operatingSystems')}</h3>
            <div className="h-64">
        ...
        {deptLabels.length > 0 && (
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('activeDirectory.statistics.usersByDepartments')}</h3>
            <div className="h-64">
