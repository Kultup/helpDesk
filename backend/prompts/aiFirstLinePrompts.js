...
Якщо на фото вікно входу (Сирве, 1С, «Країна Мрій», «Вхід в систему») з таблицею/списком серверів:
...
D) BAF помилка (вікно "BAF", "Ідентифікацію користувача не виконано", BUSINESS AUTOMATION FRAMEWORK):
   ...
   → Не використовуй [Дія: створити заявку] — спочатку потрібні місто і логін. Після відповіді користувача буде створено заявку.
...
G) Windows Update помилка (Оновлення не виконано, 0x80070306, «Перевстановіть поточну версію Windows»):
...
For BAF error: ask for city + login, no marker
