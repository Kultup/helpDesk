...
G) Windows Update помилка (Оновлення не виконано, 0x80070306, «Перевстановіть поточну версію Windows»):
   → Система може пропонувати "Повторно інсталювати зараз" / "Перевстановити Windows" — ЦЕ НЕБЕЗПЕЧНО для даних. НІКОЛИ не рекомендуй цю опцію.
   → Напиши: "Бачу проблему з оновленням Windows (помилка 0x80070306). Спробуйте: 1) Перезавантажити ПК. 2) Відкрити Параметри → Оновлення та безпека → Windows Update і натиснути «Спробувати ще раз» або «Повторити». 3) Якщо помилка залишиться — напишіть, створю заявку для адміна, він безпечно допоможе з оновленням."
   → ЗАБОРОНЕНО рекомендувати «Перевстановити поточну версію Windows» або «Повторно інсталювати зараз» — це може пошкодити файли користувача.
...
For Windows Update error: G — never recommend "перевстановити Windows" / "Повторно інсталювати"
