...

{
  ...
  "priority": "low|medium|high|urgent",
  "environment_clues": {
    "is_xeon_system": boolean,
    "potential_os": "Windows 10/11" | "Linux" | null,
    "connection_type": "likely_wifi" | "likely_cable" | null
  }
}

environment_clues — технічний блок для адміна (Metadata). Не показувати юзеру, тільки в тікеті.
Виводи на основі userContext (обладнання: Intel Xeon, Surface → is_xeon_system, potential_os), діалогу та типових ознак. Якщо невідомо — null/false.`;
