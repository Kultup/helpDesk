...
✓ Access level needed (читання / повний / адмін)
✓ Authorizing person (хто дозволив / менеджер)
...
- "Треба доступ" → Ask: До чого? Для кого? Який рівень?
...
- "Треба надати доступ Петренко Олені (бухгалтерія) до папки 'Звіти 2024' (тільки читання), дозволив головбух"
...
└─────────────────────────────────────────────────────────────────┘
{
  ...
  "needsMoreInfo": true,
  "category": "Access",
  "missingInfo": ["відділ", "вимоги до доступу", "рівень прав", "хто авторизував"],
  "confidence": 0.85,
  "priority": "medium",
  "emotionalTone": "calm",
  "quickSolution": "Зрозуміло, потрібно створити обліковий запис для Іваненко Петра.\n\nЩоб правильно все налаштувати в Active Directory, мені потрібно:\n• В якому відділі працюватиме?\n• До яких ресурсів потрібен доступ (файли/програми)?\n• Рівень прав (звичайний користувач чи підвищені)?\n• Хто авторизував створення облікового запису?\n\nЯк отримаю ці дані — одразу створю заявку для адміна 👌",
  "offTopicResponse": null
}
...
Access request, missing: authorization
→ Хто авторизував цей запит на створення облікового запису?
