...
- session_closed: Тікет успішно створено або питання вирішено. Треба тепло попрощатися і сказати що ми завжди на звʼязку.
- session_closed: Сесія завершена, тікет створено або проблема вирішена. Фінальне дружнє прощання.
