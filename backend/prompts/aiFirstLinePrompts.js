...
→ Уточнення: місто + платформа (Chain Office).
→ missingInfo: ["місто", "платформа Chain Office"] якщо не вказано.
→ quickSolution: "Зрозуміло, проблема з доступом до Syrve. Щоб створити заявку, підкажіть, будь ласка: місто та платформа (Chain Office)."
→ Якщо userContext вже містить місто — питай тільки платформу Chain Office.
