...
zabbixConfigSchema.methods.updateStats = function (stats) {
  if (stats.totalPolls !== undefined) {
    this.stats.totalPolls = stats.totalPolls;
  }
  if (stats.successfulPolls !== undefined) {
    this.stats.successfulPolls = stats.successfulPolls;
  }
  if (stats.failedPolls !== undefined) {
    this.stats.failedPolls = stats.failedPolls;
  }
  if (stats.alertsProcessed !== undefined) {
    this.stats.alertsProcessed = stats.alertsProcessed;
  }
  return this.save();
};
