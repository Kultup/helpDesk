...
const validateTicket = [
  ...
  body('assignedTo').optional().isMongoId().withMessage('Невірний ID користувача'),
  handleValidationErrors,
];
...
const validateComment = [
  ...
  body('isInternal').optional().isBoolean().withMessage('isInternal повинно бути boolean'),
  handleValidationErrors,
];
...
const validatePosition = [
  ...
  body('permissions').optional().isArray().withMessage('Дозволи повинні бути масивом'),
  handleValidationErrors,
];

// Валідація MongoDB ObjectId
const validateObjectId = paramName => [
  param(paramName).isMongoId().withMessage(`Невірний формат ${paramName}`),
  handleValidationErrors,
];
...
const validateTicketFilters = [
  ...
  query('assignedTo').optional().isMongoId().withMessage('Невірний ID користувача'),
  query('createdFrom').optional().isISO8601().withMessage('Невірний формат дати початку'),
  query('createdTo').optional().isISO8601().withMessage('Невірний формат дати кінця'),
  handleValidationErrors,
];
