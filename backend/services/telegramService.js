...
class TelegramService {
      ...
      switch (step) {
        case 'firstName':
          await this.sendMessage(chatId, 
            ...
            `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n` +
            `👤 *Крок 1/9:* Введіть ваше ім'я\n\n` +
            `💡 Ім'я повинно містити тільки літери та бути довжиною від 2 до 50 символів.`
          );
          break;
          
        case 'lastName':
          const firstNameValue = (pendingRegistration.data.firstName || '').replace(/[`_*\[\]()~>#+\-=|{}.!]/g, '\\$&');
          await this.sendMessage(chatId, 
            `✅ *Ім'я прийнято!*\n\n` +
            `👤 Ім'я: ${firstNameValue}\n\n` +
            `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n` +
            `👤 *Крок 2/9:* Введіть ваше прізвище\n\n` +
            `💡 Прізвище повинно містити тільки літери та бути довжиною від 2 до 50 символів.`
          );
          break;
          
        case 'email':
          const lastNameValue = (pendingRegistration.data.lastName || '').replace(/[`_*\[\]()~>#+\-=|{}.!]/g, '\\$&');
          await this.sendMessage(chatId, 
            `✅ *Прізвище прийнято!*\n\n` +
            `👤 Прізвище: ${lastNameValue}\n\n` +
            `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n` +
            `📧 *Крок 3/9:* Введіть вашу електронну адресу\n\n` +
            `💡 Приклад: user@example.com`
          );
          break;
          
        case 'login':
          const emailValue = (pendingRegistration.data.email || '').replace(/[`_*\[\]()~>#+\-=|{}.!]/g, '\\$&');
          await this.sendMessage(chatId, 
            `✅ *Email прийнято!*\n\n` +
            `📧 Email: ${emailValue}\n\n` +
            `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n` +
            `👤 *Крок 4/9:* Введіть ваш логін\n\n` +
            `💡 Логін повинен:\n` +
            `• Містити мінімум 3 символи\n` +
            `• Містити максимум 50 символів\n` +
            `• Складатися тільки з латинських літер, цифр та підкреслення\n\n` +
        ...
        case 'phone':
          const loginValue = (pendingRegistration.data.login || '').replace(/[`_*\[\]()~>#+\-=|{}.!]/g, '\\$&');
          await this.sendMessage(chatId, 
            `✅ *Логін прийнято!*\n\n` +
            `👤 Логін: ${loginValue}\n\n` +
            `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n` +
            `📱 *Крок 5/9:* Введіть ваш номер телефону\n\n` +
            `💡 Приклад: +380501234567\n\n` +
  ...
  async askForPassword(chatId) {
    await this.sendMessage(chatId, 
      `🔐 *Крок 6/9:* Введіть пароль\n\n` +
      `💡 Пароль повинен містити:\n` +
      `• Мінімум 6 символів\n` +
      `• Принаймні одну літеру\n` +
      `• Принаймні одну цифру\n\n` +
      `💡 *Приклад:* MyPass123\n\n` +
      `⚠️ ВАЖЛИВО: Запам'ятайте ваш пароль!\n` +
      `Він знадобиться для входу в систему.`
    );
  }
