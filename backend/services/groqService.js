...
ФОРМАТ ВІДПОВІДІ (JSON):
{
  ...
  "slaRecommendation": {
    "hours": 24,
    "reason": "ОБОВ'ЯЗКОВО вкажіть: 1) Яка складність (low/medium/high) 2) Чому така складність 3) Який пріоритет 4) Результат з таблиці. Приклад: 'Середня складність (діагностика мережі), пріоритет medium → за таблицею 24 години'"
  },
...
════════════════════════════════════════════════════════════════════════════
🟢 LOW (Низька складність) - L1 Support (перша лінія підтримки)
════════════════════════════════════════════════════════════════════════════
📊 БЕНЧМАРК ІНДУСТРІЇ: 15-60 хвилин (середній MTTR: 30 хв)

ТИПОВІ ПРОБЛЕМИ:
✓ Скидання пароля / розблокування акаунта
  └─ SLA: 1 година відповідь, 2 години вирішення (95% випадків)
  └─ Реальний час: 15-30 хвилин
  
✓ Принтер не друкує (заміна картриджа, застряг папір, підключення)
  └─ Реальний час: 20-45 хвилин
  
✓ Запити на доступ до ресурсів (папки, додатки)
  └─ Реальний час: 15-30 хвилин (без узгодження)
  └─ З узгодженням керівника: +24 години
  
✓ Підключення до WiFi, базове налаштування пошти
  └─ Реальний час: 20-40 хвилин
  
✓ Як працювати з програмою (how-to запити)
  └─ Реальний час: 15-30 хвилин
  
✓ Заміна клавіатури, миші, веб-камери
  └─ Реальний час: 20-30 хвилин (якщо є на складі)
  └─ З доставкою обладнання: +4-8 годин

════════════════════════════════════════════════════════════════════════════
🟡 MEDIUM (Середня складність) - L2 Support (друга лінія підтримки)
════════════════════════════════════════════════════════════════════════════
📊 БЕНЧМАРК ІНДУСТРІЇ: 1-8 годин (середній MTTR без AI: 30+ годин, з AI: <15 годин)

ТИПОВІ ПРОБЛЕМИ:
✓ Повільний комп'ютер (діагностика та оптимізація)
  └─ Реальний час: 1-2 години (чистка, оптимізація)
  └─ Якщо потрібна переустановка: 4-6 годин
  
✓ Встановлення/оновлення ПЗ
  └─ Стандартне ПЗ: 1-2 години
  └─ Складне корпоративне ПЗ: 3-6 годин
  └─ Переустановка Windows: 1-5 годин (залежно від налаштувань)
  
✓ Проблеми з мережею (немає інтернету, повільне з'єднання)
  └─ Діагностика: 30-60 хвилин
  └─ Вирішення: 2-4 години (якщо проблема на стороні клієнта)
  └─ Якщо залучений провайдер: +24-48 годин
  
✓ Налаштування мережевого принтера
  └─ Реальний час: 1-2 години
  
✓ Відновлення даних з backup
  └─ Малі файли: 1-2 години
  └─ Великі обсяги: 4-8 годин
  
✓ Проблеми з Email (Outlook, IMAP, SMTP)
  └─ Реальний час: 1-3 години

════════════════════════════════════════════════════════════════════════════
🔴 HIGH (Висока складність) - L3 Support (експертна команда)
════════════════════════════════════════════════════════════════════════════
📊 БЕНЧМАРК ІНДУСТРІЇ: 4-48+ годин (MTTR для критичного обладнання: <5 годин)

ТИПОВІ ПРОБЛЕМИ:
✓ Заміна апаратного забезпечення (материнка, процесор, HDD→SSD)
  └─ Діагностика: 1-2 години
  └─ Заміна + налаштування: 3-6 годин
  └─ Очікування запчастин: +24-72 години
  └─ MTTR для критичних систем: <5 годин
  
✓ Переустановка ОС з нуля + налаштування
  └─ Реальний час: 4-8 годин (включно з ПЗ, драйверами, налаштуваннями)
  
✓ Проблеми з сервером (не відповідає, критична помилка)
  └─ SLA для P1 incidents: відповідь протягом 1 години
  └─ Реальний час вирішення: 2-12 годин залежно від проблеми
  
✓ Налаштування серверного обладнання
  └─ Реальний час: 8-24 години
  
✓ Віруси, шкідливе ПЗ, ransomware
  └─ Базове видалення: 2-4 години
  └─ Повне відновлення системи: 8-24 години
  └─ Якщо зачеплено мережу: 24-72 години
  
✓ Проблеми з базою даних
  └─ Реальний час: 4-24 години залежно від складності
  
✓ Мережева інфраструктура (маршрутизатор, комутатор, VPN)
  └─ Налаштування: 4-12 годин
  └─ Діагностика складної проблеми: 8-24 години
  
✓ Міграція даних між системами
  └─ Реальний час: 12-48+ годин залежно від обсягу
...
════════════════════════════════════════════════════════════════════════════
📚 РОЗШИРЕНА БАЗА ПРИКЛАДІВ (50+ сценаріїв)
════════════════════════════════════════════════════════════════════════════
...
════════════════════════════════════════════════════════════════════════════
🎯 АЛГОРИТМ ВИЗНАЧЕННЯ SLA
════════════════════════════════════════════════════════════════════════════
1. Прочитайте опис проблеми
2. Визначте ТИП проблеми (пароль/принтер/мережа/обладнання/ПЗ/сервер)
3. Знайдіть ПОДІБНИЙ ПРИКЛАД вище
4. Визначте СКЛАДНІСТЬ (LOW/MEDIUM/HIGH) на основі бенчмарків
5. Врахуйте ПРІОРИТЕТ з тікета
6. Використайте ТАБЛИЦЮ для базового SLA
7. Застосуйте КОРИГУВАЛЬНІ ФАКТОРИ якщо потрібно
8. Поверніть КОНКРЕТНЕ ЧИСЛО годин
`;
