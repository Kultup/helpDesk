...
// // Пошук користувачів (тільки адміни)
// router.get('/search/query', authenticateToken, adminAuth, [
//   query('q')
//     .trim()
//     .isLength({ min: 2 })
...
// // Отримати користувачів за містом (тільки адміни)
// router.get('/city/:cityId', authenticateToken, adminAuth, [
//   param('cityId').isMongoId().withMessage('Невірний ID міста'),
//   ...queryValidation
// ], userController.getUsersByCity);

// // Отримати користувачів за посадою (тільки адміни)
// router.get('/position/:positionId', authenticateToken, adminAuth, [
//   param('positionId').isMongoId().withMessage('Невірний ID посади'),
//   ...queryValidation
// ], userController.getUsersByPosition);

// // Отримати користувачів за роллю (тільки адміни)
// router.get('/role/:role', authenticateToken, adminAuth, [
//   param('role').isIn(['admin', 'user']).withMessage('Невірна роль'),
//   ...queryValidation
// ], userController.getUsersByRole);

// // Активувати/деактивувати користувача (тільки адміни)
// router.patch('/:id/toggle-status', authenticateToken, adminAuth, idValidation, userController.toggleUserStatus);

// // Скинути пароль користувача (тільки адміни)
// router.post('/:id/reset-password', authenticateToken, adminAuth, idValidation, userController.resetUserPassword);

// Отримати статистику користувачів (тільки адміни)
// router.get('/statistics/overview', authenticateToken, adminAuth, userController.getUserStatistics);

// Експорт користувачів (тільки адміни)
...
// // Масове оновлення користувачів (тільки адміни)
// router.patch('/bulk/update', authenticateToken, adminAuth, [
//   body('userIds')
//     .isArray({ min: 1 })
//     .withMessage('userIds повинен бути непустим масивом'),
//   body('userIds.*')
//     .isMongoId()
//     .withMessage('Кожен ID користувача повинен бути валідним'),
//   body('updates')
//     .isObject()
...
// // Масове видалення користувачів (тільки адміни)
...
// // Отримати активність користувача (тільки адміни або власник)
// router.get('/:id/activity', authenticateToken, idValidation, userController.getUserActivity);
