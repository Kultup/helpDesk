...
const createCommentValidation = [
  ...
  body('parentId')
    .optional()
    .isMongoId()
    .withMessage('Невірний ID батьківського коментаря'),
  ...
  body('attachments')
    .optional()
    .isArray()
    .withMessage('Вкладення повинні бути масивом'),
  ...
  body('attachments.*.url')
    .optional()
    .isURL()
    .withMessage('Невірний URL файлу'),
...
const updateCommentValidation = [
  param('id')
    .isMongoId()
    .withMessage('Невірний ID коментаря'),
