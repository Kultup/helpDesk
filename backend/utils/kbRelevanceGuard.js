...
const TOPIC_KEYWORDS = {
  ...
  // Конвертація документів (окремо від друку — не показувати при проблемах з принтером)
  document_conversion: ['конвертація', 'пдф', 'pdf', 'конвертувати документ', 'перетворити pdf'],
  // Статті не про техпідтримку (щоб не показувати при технічних запитах)
  general_offtopic: ['президент', 'україна', 'держава', 'конституція', 'політика', 'вибори'],
};
