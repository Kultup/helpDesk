...
class RetryHelper {
     ...
     * @returns {Promise<any>}
     */
    async retryAIRequest(aiFunction, operationName = 'AI request') {
     ...
     * @returns {Promise<any>}
     */
    async retryDatabaseRequest(dbFunction, operationName = 'Database request') {
     ...
     * @returns {Promise<any>}
     */
    async retryExternalAPI(apiFunction, operationName = 'External API request') {
