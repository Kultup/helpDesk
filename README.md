...
- **Groq AI** - швидкий безкоштовний AI асистент
- **OpenAI (ChatGPT)** - потужний AI асистент (опціонально, платно)
...
## 🤖 AI Асистент (Groq та OpenAI)

Система підтримує два AI провайдери для інтелектуальної обробки запитів:

### Підтримувані провайдери:
- **Groq AI** - швидкий, безкоштовний (рекомендовано для початку)
- **OpenAI (ChatGPT)** - потужний, платний (опціонально)

### Можливості AI:
- 💬 Автоматичні відповіді на запитання користувачів в Telegram
- 🎯 Аналіз наміру користувача (чи потрібен тікет)
- 📝 Генерація уточнюючих питань для створення детальних тікетів
- 🏷️ Автоматичне визначення категорії та пріоритету тікетів
- ⏱️ Розумне встановлення SLA на основі аналізу проблеми
- 📊 Генерація AI звітів та аналітики
- 🎤 Транскрипція голосових повідомлень
- ❓ Автоматична генерація FAQ з історії тікетів

### Швидке налаштування:

1. **Відкрийте веб-інтерфейс** → Налаштування → AI Асистент
2. **Виберіть провайдера:** Groq (безкоштовно) або OpenAI (платно)
3. **Вставте API ключ:**
   - Groq: [console.groq.com/keys](https://console.groq.com/keys)
   - OpenAI: [platform.openai.com/api-keys](https://platform.openai.com/api-keys)
4. **Увімкніть AI асистента** та збережіть

📚 Детальна інструкція: [AI_PROVIDER_SETUP.md](./AI_PROVIDER_SETUP.md)
...
 
 
#   T e s t   w e b h o o k   t r i g g e r 
 
 
...
 
 
#   C l e a n   a u t o - d e p l o y   t e s t 
 
 
